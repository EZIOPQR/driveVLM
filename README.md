...
Since that the QA pairs in [v1_1_val_nus_q_only.json](https://drive.google.com/file/d/1fsVP7jOpvChcpoXVdypaZ4HREX1gA7As/view) doesn't have labels. We have re-partitioned the samples in `v1_1_train_nus.json`, splitting them into 80% and 20% subsets to form the training and test sets for fine-tuning and inference in this project.
...
Then the data origanization is
